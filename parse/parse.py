...
def parse(rlang_type): 
    input_rlang_file = f'rlang_{rlang_type}_output.txt'
    output_rlang_tokenized_file = f'tokenized_{rlang_type}_output.txt'
    cfg_file = f'rlang_{rlang_type}.cfg'
    ...
    with open(os.path.join(script_dir, "../data/" + input_rlang_file), 'r') as f_input:
        with open(os.path.join(script_dir, "../data/" + output_rlang_tokenized_file), 'w') as f_output:
            ...
            print(f"Writing tokenized file for {rlang_type} to ", output_rlang_tokenized_file)
